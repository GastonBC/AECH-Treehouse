...
namespace RLD
{
    ...
    public class Gizmo
    {
        ...
        public BoxGizmo BoxGizmo { get { return _boxGizmo; } }
        public ObjectExtrudeGizmo ObjectExtrudeGizmo { get { return _objectExtrudeGizmo; } }
        ...
        public bool AddBehaviour(IGizmoBehaviour behaviour)
        {
            ...
            else if (behaviourType == typeof(BoxGizmo)) _boxGizmo = behaviour as BoxGizmo;
            else if (behaviourType == typeof(ObjectTransformGizmo)) _objectTransformGizmo = behaviour as ObjectTransformGizmo;
            else if (behaviourType == typeof(ObjectExtrudeGizmo)) _objectExtrudeGizmo = behaviour as ObjectExtrudeGizmo;
        ...
        public bool RemoveBehaviour(IGizmoBehaviour behaviour)
        {
            ...
            else if (behaviour == _boxGizmo) _boxGizmo = null;
            else if (behaviour == _objectTransformGizmo) _objectTransformGizmo = null;
            else if (behaviour == _objectExtrudeGizmo) _objectExtrudeGizmo = null;
